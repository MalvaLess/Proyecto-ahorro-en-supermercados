...
Revision ID: 295fdda6976a
Revises: 
Create Date: 2026-05-25 21:20:05.170543
...
def upgrade():
    ...
    sa.Column('normalizedName', sa.String(length=50), nullable=True),
    ...
    sa.Column('normalizedName', sa.String(length=255), nullable=False),
    ...
    sa.Column('capturedAt', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('createdAt', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
